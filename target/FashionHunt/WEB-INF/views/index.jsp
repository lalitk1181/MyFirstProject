...
<html>
<head>
<title>Fashion Hunt a E-Commerce Online Shopping Category Flat Bootstrap Responsive Website Template | Home :: w3layouts</title>
<!--css-->
	...
	<!--header-->
				...
				<div class="container">
					<div class="logo-nav">
						<div class="logo-nav-left">
							<h1><a href="index.html">Fashion Hunt <span>Shop anywhere</span></a></h1>
						</div>
		...
		<!---footer--->
						...
						<div class="container">
							<div class="footer-grids">
								<div class="col-md-3 footer-grid">
									<h4>About </h4>
									<p>Fashion Hunt Pvt Ltd. is an e-commerce company based in Gurugram, India. Founded by Lalit Kumar in 2019, the company initially focused on clothes, electronics, fashion, and lifestyle products.</p>
								...
								<div class="col-md-3 footer-grid foot">
									<h4>Contacts</h4>
									<ul>
										<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i><a href="#">sector-15, Gurugram, INDIA</a></li>
										<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i><a href="#">9716188837</a></li>
										<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:example@mail.com"> lalitk1181@mail.com</a></li>
					...
					<div class="copy-section">
						<div class="container">
							<div class="copy-left">
								<p>&copy; 2019 Fashion Hunt . All rights reserved </p>
							</div>
